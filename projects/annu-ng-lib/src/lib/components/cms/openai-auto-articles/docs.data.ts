...
import { OpenaiPromptType } from '../../common-ui/openai-form/openai-form.interface';
import { DocsData } from '../../docs/docs.interface';
import { EMPTY_PROMPT_QUEUE_ITEM } from './openai-auto-articles.constants';
import { OpenaiPromptQueueItem, OpenaiPromptQueueItemStatus, OpenaiArticleQueueItem } from './openai-auto-articles.interface';
    ...
    openaiPromptQueue: [
      ...
      },
      {
        ...
        prompt: {
          ...
          promptType: OpenaiPromptType.keywords,
          message: {
            mdText: '',
            htmlText: '',
            jsonText: '',
      ...
      },
      {
        ...
        prompt: {
          ...
          promptType: OpenaiPromptType.description,
          message: {
            mdText: '',
            htmlText: '',
            jsonText: '',
...
export const OpenaiAutoArticlesComponent: DocsData = {
  projectionContent: '',
  inputPropsValues: {
    openaiArticleQueue: [],
    appConfig,
